										...
										<div class="GridLex-grid-noGutter-equalHeight GirdLex-grid-bottom">
											...
											<div class="GridLex-col-7_sm-12_xs-12_xss-12">
												...
												<div class="GridLex-inner">
													...
													<ul class="user-meta">
														<li><i class="fa fa-map-marker"></i> Bithoor , Kanpur <span class="mh-5 text-muted">|</span> <i class="fa fa-phone"></i> +91 8756144680</li>
														<li>
							...
							<div class="container">
								...
								<div class="inner-bottom">
									...
									<ul class="user-header-menu">
										<li class="active"><a href="anuj.php">Profile</a></li>
										<li><a href="anujreview.php">Reviews</a></li>
										<li><a href="anujfollowing.php">Followings <span>25</span></a></li>
									</ul>
					...
					<div class="row">
						...
						<div id="sidebar-sticky" class="col-xs-12 col-sm-5 col-md-4 mt-20">
							...
							<div class="ml-10 ml-0-xs mb-10">
								<a href="anujpayment.php" class="btn btn-primary btn-lgg btn-block btn-border">Book me Now</a>
							</div>
