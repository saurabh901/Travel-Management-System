					...
					<div class="blog_post_container">
						...
						<div class="blog_post">
							<div class="blog_post_image">
								...
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">oct, 2019</div>
								</div>
							</div>
							<div class="blog_post_meta">
								<ul>
							...
							<ul>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">June 5, 2019</a></div>
										</div>
									</div>
								</li>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">Nov 21, 2019</a></div>
										</div>
									</div>
								</li>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by Jane Smith</a></div>
											<div class="latest_post_date trans_200"><a href="#">Oct 9, 2019</a></div>
										</div>
									</div>
								</li>
				...
				<div class="col-lg-3 footer_column">
					<div class="footer_col">
						...
						<div class="footer_content footer_blog">
							...
							<!-- Footer blog item -->
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="images/manali.jpg" alt="https://unsplash.com/@deannaritchie"></div>
								<div class="footer_blog_content">
							...
							<!-- Footer blog item -->
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="images/mathura.jpg" alt="https://unsplash.com/@bergeryap87"></div>
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.php">Travel with us this year</a></div>
