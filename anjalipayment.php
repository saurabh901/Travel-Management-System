	...
	<!-- Contact -->
							...
							<div class="trip-list-item no-border">
								<div class="image-absolute">
									<div class="image image-object-fit image-object-fit-cover">
										<img src="images/anjali.jpg" alt="image" >
									</div>
								</div>
								<div class="content">
										...
										<div class="GridLex-grid-noGutter-equalHeight GridLex-grid-middle">
											...
											<div class="GridLex-col-6_sm-12_xs-12_xss-12">
												...
												<div class="GridLex-inner">
													<h6>Anjali</h6>
													<span class="font-italic font14">53 tours - 443 reviews - 8 awards</span>
												</div>
											...
											<div class="GridLex-col-3_sm-6_xs-7_xss-12">
												<div class="GridLex-inner line-1 font14 text-center text-left-sm text-muted spacing-1">
													<div class="rating-item rating-item-lg  mt-10-xs">
														...
														<div class="rating-text">Based on <a href="anjalireview.php">32 reviews</a></div>
													</div>
												</div>
											</div>
			...
			<div class="pt-30 pb-50">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="date" id="datepicker-13" class="form-control datepicker px-2" placeholder="Date of visit">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" id="datepicker-13" class="form-control datepicker px-2" placeholder="">
                </div>
                <div class="col-md-6">
