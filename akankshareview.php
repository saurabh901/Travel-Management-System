...
<link rel="stylesheet" type="text/css" href="styles/guidereview_styles.css">
<link rel="stylesheet" type="text/css" href="styles/guidereview_responsive.css">
...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">guide review</div>
		</div>
	</div>
										...
										<div class="GridLex-grid-noGutter-equalHeight GirdLex-grid-bottom">
											...
											<div class="GridLex-col-7_sm-12_xs-12_xss-12">
												...
												<div class="GridLex-inner">
													...
													<ul class="user-meta">
														<li><i class="fa fa-map-marker"></i> Ramadevi , Kanpur <span class="mh-5 text-muted">|</span> <i class="fa fa-phone"></i> +91 8756144680</li>
														<li>
													...
													<div class="row gap-20">
														<div class="col-xss-6 col-xs-6 col-sm-6 col-md-12 text-right text-left-sm">
															<div class="rating-wrapper mb-10">
																<div class="rating-item rating-item-lg"><h3>*****</h3>
																	...
																	<span class="block line14">based on <a href="akankshareview.php">25reviews</a></span>
																</div>
															</div>
														</div>
														<div class="col-xss-6 col-xs-6 col-sm-6 col-md-12 text-right text-left-sm">
															<div class="user-header-price mt-5-sm">
																<span class="block-sm">From</span> <span class="text-primary number">₹50000</span> 
															</div>
														</div>
													</div>
							...
							<div class="container">
								...
								<div class="inner-bottom">
									...
									<ul class="user-header-menu">
										<li class="active"><a href="akanksha.php">Profile</a></li>
										<li><a href="akankshareview.php">Reviews</a></li>
										<li><a href="akankshafollowing.php">Followings <span>25</span></a></li>
									</ul>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-7 col-md-8 mt-20">
							...
							<div class="review-wrapper">
								...
								<div class="review-content">
									...
									<ul class="review-list">
										...
										<li class="clearfix">
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-12 col-md-3">
													<div class="review-header">
														<h6>akanksha</h6>
														<span class="review-date">10: 34 - May 25, 2019</span>
												...
												<div class="col-xs-12 col-sm-12 col-md-9">
													...
													<div class="review-content">
														...
														<p>It as announcing it me stimulated frequently continuing. 
														Least their she you now above going stand forth. He pretty future afraid should genius spirit on. 
														Set property addition building put likewise get. Of will at sell well at as. Too want but tall nay like old. 
														Removing yourself be in answered he.</p>
													...
													<div class="review-replied">
														...
														<div class="review-replied-header">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8 col-md-9">
																	<h6>Akanksha <small>owner of this tour</small></h6>
																	- <span class="review-date">12: 44 - may 25, 2019</span>
																</div>
														...
														<div class="review-replied-content">
															...
															<p>Society excited by cottage private an it esteems.
															Fully begin on by wound an. Girl rich in do up or both. At declared in as rejoiced of together.
															He impression collecting delightful unpleasant by prosperous as on. End too talent she object mrs wanted remove giving.</p>
													...
													<a href="#" class="review-load-more"><b>load more...</b></a>
										...
										<li class="clearfix">
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-12 col-md-3">
													<div class="review-header">
														<h6>Shyam ji sharma</h6>
														<span class="review-date">09: 54 - Jan 15, 2019</span>
												...
												<div class="col-xs-12 col-sm-12 col-md-9">
													...
													<div class="review-content">
														...
														He impression collecting delightful unpleasant by
														prosperous as on. End too talent she object mrs wanted
														remove giving.</p>
													...
													<div class="review-replied">
														...
														<div class="review-replied-header">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8 col-md-9">
																	<h6>Ram <small>owner of this tour</small></h6>
																	- <span class="review-date">10: 34 - july 5, 2019</span>
																</div>
														...
														<div class="review-replied">
															...
															<div class="review-replied-header">
																...
																<div class="row">
																	...
																	<div class="col-xs-12 col-sm-8 col-md-9">
																		<h6>Antony Robert</h6>
																		- <span class="review-date">10: 34 - Jan 25, 2019</span>
																	</div>
										...
										<li class="clearfix">
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-12 col-md-3">
													<div class="review-header">
														<h6>Ashwani</h6>
														<span class="review-date">05:48 - Jan 25, 2019</span>
												...
												<div class="col-xs-12 col-sm-12 col-md-9">
													...
													<div class="review-content">
														...
														<h4>Over many our good lady feet ask that</h4>
														<p>It as announcing it me stimulated frequently continuing. Least their she you now above going stand forth. He pretty future afraid should genius spirit on. Set property addition building put likewise get. Of will at sell well at as. Too want but tall nay like old.</p>
									...
									<a href="#" class="review-load-more mb-40"><b>load more...</b></a>
									...
									<form class="">
										...
										<div class="row">
											...
											<div class="col-sm-12 col-md-8">
												<a href="#" class="btn btn-primary btn-lg"><b>Submit</b></a>
											</div>
						...
						<div id="sidebar-sticky" class="col-xs-12 col-sm-5 col-md-4 mt-20">
							...
							<div class="ml-10 ml-0-xs mb-10">
								<a href="akankshapayment.php" class="btn btn-primary btn-lgg btn-block btn-border">Book me Now</a>
							</div>
