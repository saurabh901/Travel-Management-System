...
<!--four-grids here-->
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits"style="background-color:#48b4e0;">
							<div class="icon">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><a href=""><b>User</b></a></h3>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo" style="background-color:#48b4e0;">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><a href="manage-bookings.php"><b>Guide Bookings</b></a></h3>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls" style="background-color:#48b4e0;">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><a href=""><b>Enquiries</b></a></h3>
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree"style="background-color:#48b4e0;">
							<div class="icon">
								<i class="glyphicon glyphicon-briefcase" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><a href="manage-guide.php"><b>Total Guide packages</b></a></h3>
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls" style="background-color:#48b4e0;">
							...
							<div class="four-text">
								<h3><a href=""><b>Issues Riaised</b></a></h3>
