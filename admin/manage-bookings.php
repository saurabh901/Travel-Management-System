...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Manage Guide Bookings</li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->GuideId);?></td>
							...
							<td><a href="update-guide.php?gid=<?php echo htmlentities($result->gid);?>"><?php echo htmlentities($result->gname);?></a></td>
...
{
echo "Cancel by you at  " .$result->UpdationDate;
} 
if($result->status==2 and $result->CancelledBy=='u')
{
echo "Cancel by User at  " .$result->UpdationDate;
