...
<link rel="stylesheet" type="text/css" href="styles/guidepayment_styles.css">
<link rel="stylesheet" type="text/css" href="styles/guidepayment_responsive.css">
<link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.min.css" media="screen">	
<link rel="stylesheet" type="text/css" href="styles/bootstrap4/bootstrap.min.css">

	<link href="styles/main.css" rel="stylesheet">
	<link href="styles/plugin.css" rel="stylesheet">
	<link href="styles/style.css" rel="stylesheet">
	<link href="styles/your-style.css" rel="stylesheet">
...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="phone">+91 8317046454</div>
						<div class="social">
						...
						<div class="user_box ml-auto">
							...
							<div class="user_box_register user_box_link"><a href="signup.php">sign up</a></div>
						</div>
					</div>
				</div>
			</div>		
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo.png" alt="">touriam management system</a></div>
						</div>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/tourism.jpg"></div>
		<div class="home_content">
			<div class="home_title">guide payment</div>
		</div>
	</div>
										...
										<div class="GridLex-grid-noGutter-equalHeight GridLex-grid-middle">
											...
											<div class="GridLex-col-6_sm-12_xs-12_xss-12">
												...
												<div class="GridLex-inner">
													<h6>Pragya</h6>
													<span class="font-italic font14">13 tours - 143 reviews - 10 awards</span>
												</div>
											...
											<div class="GridLex-col-3_sm-6_xs-7_xss-12">
												<div class="GridLex-inner line-1 font14 text-center text-left-sm text-muted spacing-1">
													<div class="rating-item rating-item-lg  mt-10-xs">
														...
														<div class="rating-text">Based on <a href="pragyareview.php">32 reviews</a></div>
													</div>
												</div>
											</div>
			...
			<div class="pt-30 pb-50">
									...
									<div class="payment-traveller">
										...
										<div class="form-horizontal">
											<div class="form-group select2-input-hide">
												<label class="col-sm-3 col-md-2 control-label"><b>Distination:</b></label>
												<div class="col-sm-3 col-md-2">
													<select>
														<option value="">Select</option>
                    <option value="">Kanpur</option>
                    <option value="">Ganga bairaj</option>
                    <option value="">Bithoor</option>
                    <option value="">Zsquare</option>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="lname" class="form-control" placeholder="Last Name"required>
										...
										<div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label class="text-black" for="date"><b>Date of Travel :</b></label> 
                  <input type="date" id="datepicker-13" class="form-control datepicker px-2" placeholder="Date of visit"required>
                </div>
                <div class="col-md-6">
                  ...
                  <input type="email" id="email" class="form-control" placeholder="Email"required>
										...
										<div class="form-horizontal">
											<div class="form-group select2-input-hide">
												<label class="col-sm-3 col-md-2 control-label"><b>Gender:</b></label>
												<div class="col-sm-3 col-md-2">
													<select>
														<option value="">Select</option>	
										...
										<div class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-3 col-md-2 control-label"><b>Mobile:</b></label>
										...
										<div class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-3 col-md-2 control-label"><b>Person No:</b></label>
												<div class="col-sm-5 col-md-5">
													<select>
														<option value="">Select</option>
                    ...
                    <option value="">5+</option>
										...
										<div class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-3 col-md-2 control-label"><b>Nationality:</b></label>
												<div class="col-sm-5 col-md-5">
													<select>
														<option value="">Select</option>	
								...
								<div class="payment-content">
									...
									<h4 class="section-title">Billing Address</h4>
															 ...
															 <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label class="text-black" for="fname"><b>Address :</b></label>
                  <input type="text" id="fname" class="form-control" placeholder=""required>
                </div>
                <div class="col-md-6">
                  <label class="text-black" for="lname"><b>City :</b></label>
                  <input type="text" id="lname" class="form-control" placeholder=""required>
										...
										<div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label class="text-black" for="date"><b>Postal :</b></label> 
                  <input type="text" id="datepicker-13" class="form-control datepicker px-2" placeholder=""required>
                </div>
                <div class="col-md-6">
                  <label class="text-black" for="email"><b>Provence :</b></label> 
                  <input type="text" id="email" class="form-control" placeholder=""required>
									...
									<div class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-3 col-md-2 control-label"><b>Country:</b></label>
												<div class="col-sm-5 col-md-5">
													<select>
														<option value="">Select</option>	
									...
									<div id="paymentOption" class="payment-option-wrapper">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												...
												<div class="radio-block">
													...
													<label class="" for="payments1"><span>Credit Cards :</span> <img src="images/credit.jpg" alt="Image"></label>
												</div>
											...
											<div class="col-sm-12">
												...
												<div class="radio-block">
													<input id="payments1" name="payments" type="radio" class="radio" value="paymentsCreditCard"/>
													<label class="" for="payments1"><span>Debit Cards :</span> <img src="images/credit.jpg" alt="Image"></label>
												</div>
											...
											<div class="col-sm-12">
												<div class="radio-block">
													...
													<label class="" for="payments2"><span>Paypal</span> <img src="images/pay1.jpg" alt="Image"></label>
												</div>
											</div>
										...
										<div id="paymentsCreditCard" class="payment-option-form">
											...
											<div class="inner">
												...
												<h5 class="mb-15 text-primary mt-15 text-uppercase spacing-2">Your Payment Total: ₹ 50,000</h5>
												<p>The booking amount will be debited from your credit card once the booking is completed. </p>
											
												<div class="form-horizontal">
													<div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label class="text-black" for="Cardholder's name"><b>Cardholder's name :</b></label>
                  <input type="text" id="fname" class="form-control" placeholder=""required>
                </div>
                <div class="col-md-6">
                &nbsp &nbsp   <label class="text-black" for="lname"><b>Card Type :</b></label>
                  <div class="col-sm-3 col-md-3">
													...
													<div class="form-group">
														<label class="col-sm-3 col-md-3 control-label"><b>Card number :</b></label>
														<div class="col-sm-6 col-md-6">
															<input type="text" class="form-control mb-0" placeholder=""required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 col-md-3 control-label"><b>Expiry date :</b> </label>
														<div class="col-sm-3 col-md-3">
															<select>
...
<option value="December">Dec</option>
														...
														<span><div class="col-sm-3 col-md-3">
															<select>
													...
													<div class="form-group">
														<label class="col-sm-3 col-md-3 control-label"><b>CVC</b><small class="hoover-help of-label" data-toggle="tooltip" data-placement="top" title="Had denoting properly jointure you occasion directly raillery. In said to of poor full be post face snug."><b>What is it?</b></small> </label>
														<div class="col-sm-3 col-md-2">
															<input type="text" class="form-control mb-0" placeholder=""required>
														</div>
													</div>
								...
								<a class="btn btn-primary mt-25" href="paymentdone.php">Book Now</a>
								...
								<div class="sidebar-booking-box">
									...
									<div class="sidebar-booking-inner">
										...
										<ul class="price-summary-list">
											...
											<li>
												<h6>Meeting point</h6>
												<p class="text-muted">Kalyanpur</p>
											</li>
											...
											<li>
												<div class="row gap-10 mt-10">
													...
													<div class="col-xs-5 col-sm-5 text-right">
														₹25000 x2
														<span class="font600 font26 block text-primary mt-5">₹50,000</span>
													</div>
												</div>
											</li>
            ...
            <div class="p-4 mb-3 bg-white"style="width:500px; margin-right:50px;">
              <img src="images/booking.jpg" alt="Image" class="img-fluid mb-4 rounded">
					...
					<div class="footer_col">
						<div class="footer_content footer_about">
							<div class="logo_container footer_logo">
								<div class="logo"><a href="#"><img src="images/logo.png" alt="">tourism management system</a></div>
							</div>
						...
						<div class="footer_content footer_blog">
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									...
									<div class="footer_blog_date">july 9, 2017</div>
								</div>
							</div>
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									...
									<div class="footer_blog_date">dec 12, 2018</div>
								</div>
							</div>
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.php">Travel with us this year</a></div>
									<div class="footer_blog_date">may 23, 2019</div>
								</div>
							</div>
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								<li class="contact_info_item d-flex flex-row">
									...
									<div class="contact_info_text">saurabh</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="images/phone-call.svg" alt=""></div></div>
									<div class="contact_info_text">8317046454</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="images/message.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">saurabhkumarjha291@gmail.com</a></div>
								</li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">saurabh</a>
