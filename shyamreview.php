										...
										<div class="GridLex-grid-noGutter-equalHeight GirdLex-grid-bottom">
											...
											<div class="GridLex-col-7_sm-12_xs-12_xss-12">
												...
												<div class="GridLex-inner">
													...
													<ul class="user-meta">
														<li><i class="fa fa-map-marker"></i> gurudev , Kanpur <span class="mh-5 text-muted">|</span> <i class="fa fa-phone"></i> +91 8756144680</li>
														<li>
														...
														<div class="col-xss-6 col-xs-6 col-sm-6 col-md-12 text-right text-left-sm">
															<div class="rating-wrapper mb-10">
																<div class="rating-item rating-item-lg"><h3>*****</h3>
																	...
																	<span class="block line14">based on <a href="shyamreview.php">25reviews</a></span>
																</div>
															</div>
														</div>
														<div class="col-xss-6 col-xs-6 col-sm-6 col-md-12 text-right text-left-sm">
							...
							<div class="container">
								...
								<div class="inner-bottom">
									...
									<ul class="user-header-menu">
										<li class="active"><a href="shyam.php">Profile</a></li>
										<li><a href="shyamreview.php">Reviews</a></li>
										<li><a href="shyamfollowing.php">Followings <span>25</span></a></li>
									</ul>
					...
					<div class="row">
						...
						<div id="sidebar-sticky" class="col-xs-12 col-sm-5 col-md-4 mt-20">
							...
							<div class="ml-10 ml-0-xs mb-10">
								<a href="shyampayment.php" class="btn btn-primary btn-lgg btn-block btn-border">Book me Now</a>
							</div>
